...
public:
    ...
    // Todo: Lägg till två metoder så att vi vid simulering kan sätta att tempsensorn är initerad (eller inte)
    // samt skriva temperaturen (vi har ju ingen hårdvara, så vi behöver kunna sätta detta via set-metoder, typ setTemp(500)).
